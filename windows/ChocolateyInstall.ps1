...
# === EDIT HERE ===
$packageRepo = 'https://chocoserver:8443/repository/Prod/'
...
function Download-Package
{
    ...
    $packageFeedEntryContentSrc = $pkg.feed.entry.content.src
    $packageDownloadUrl = if ( $packageFeedEntryContentSrc -is [array] ) { $packageFeedEntryContentSrc[-1] } else { $packageFeedEntryContentSrc }
